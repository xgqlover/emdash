...
export const plugin = definePlugin(
  {
    id: 'xiangwo-caiwuzongguan',
    name: '财务总管',
    description: '财务总管 bot（独立 persona + 记忆 + 工作文件夹），项我 @caiwuzongguan 路由',
  },
  {
    prompt: { kind: 'none' },
    ...
    hostDependency: { id: 'xiangwo-caiwuzongguan', binaryNames: ['/usr/bin/python3'] },
  },
  { icon }
);
